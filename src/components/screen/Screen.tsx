...
const Screen = () => {
  ...
  return (
    <div className={`${theme === 0 ? 'bg-[#181f32]' : ''}${theme === 1 ? 'bg-white' : ''}${theme === 2 ? 'bg-[#1e0836]' : ''} max-h-[10rem] w-[40rem] mx-auto px-10 rounded-2xl flex flex-col justify-center gap-2 pb-6`}>
